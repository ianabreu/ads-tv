...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        default: "bg-amber-500 text-primary hover:bg-amber-500/90",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/80",
        confirm:
          "bg-green-700 text-destructive-foreground hover:bg-green-700/80",
        alert: "bg-amber-700 text-destructive-foreground hover:bg-amber-700/80",
        outline:
          "border border-slate-400 text-slate-400 bg-transparent hover:bg-slate-400 hover:border-slate-400 hover:text-slate-900",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-white hover:text-amber-500 justify-start",
      },
      size: {
